...
// Open the Media Player preview popup
function player_popup() {
		window.focus();
		player_popupWin = window.open("<?php echo($ChatPath); ?>player_popup.php?<?php echo("L=$L"); ?>","player_popup","width=600,height=400,resizable=no,scrollbars=no,toolbar=no,menubar=no,status=yes,location=no");
		player_popupWin.focus();
}
...
#	$updatepath2 = "http://phpmychat.svn.sourceforge.net/viewvc/phpmychat/trunk/lib/update.php";
	$updatepath2 = "http://svn.code.sf.net/p/phpmychat/code/trunk/lib/update.php";
	if (@fsockopen("ciprianmp.com", 80, $errno, $errstr, 2))
	{
		...
		if (isset($_GET['alv']) && isset($_GET['alm'])) {
			...
			settype($app_last_version, "float");
		} else {
	...
	elseif (@fsockopen("http://svn.code.sf.net/p/phpmychat/code/", 80, $errno, $errstr, 2))
	{
		$upd_possible = 1;
		if (isset($_GET['alv']) && isset($_GET['alm'])) {
			define("APP_LAST_VERSION", $alv);
	...
	<dl>
		<dt onmouseover="javascript:show('smenu4');"><?php echo A_CONF_27; ?></dt>
			<dd id="smenu4" onmouseover="javascript:show('smenu4');" onmouseout="javascript:show('');">
				<ul>
					<li><a href="https://sourceforge.net/p/phpmychat/code/HEAD/tree/trunk/docs/plus%20docs/Fixes%20readme.txt#l40" target=_blank Title="<?php echo(sprintf(L_CLICKS, L_LINKS_15, sprintf(A_CONF_33, APP_NAME." - ".APP_LAST_VERSION.APP_LAST_MINOR))); ?>" onMouseOver="window.status='<?php echo(sprintf(L_CLICKS, L_LINKS_15, sprintf(A_CONF_33, APP_NAME." - ".APP_LAST_VERSION.APP_LAST_MINOR))); ?>.'; return true"><?php echo (sprintf(A_CONF_33, APP_LAST_VERSION.APP_LAST_MINOR)); ?></a></li>
 <?php
...
#	elseif (strpos(APP_LAST_MINOR,"ß") !== false || stripos(APP_LAST_MINOR,"RC") !== false) $minor_dir = "/Betas/";
	?>
						<li><a href="https://sourceforge.net/projects/phpmychat/files/phpMyChat_Plus/<?php echo(APP_LAST_VERSION); ?>" target=_blank Title="<?php echo sprintf(A_CONF_ERR_4, APP_LAST_VERSION.APP_LAST_MINOR); ?>" onMouseOver="window.status='<?php echo sprintf(A_CONF_ERR_4, APP_LAST_VERSION.APP_LAST_MINOR); ?>.'; return true"><?php echo sprintf(A_CONF_35, APP_LAST_VERSION.APP_LAST_MINOR); ?></a></li>
 <?php
 }
 else
 {
	?>
					<li><a href="https://sourceforge.net/projects/phpmychat/files/phpMyChat_Plus/<?php echo(APP_VERSION); ?>" target=_blank Title="<?php echo(sprintf(L_CLICKS, L_LINKS_15, A_CONF_28)); ?>" onMouseOver="window.status='<?php echo(sprintf(L_CLICKS, L_LINKS_15, A_CONF_28)); ?>.'; return true"><?php echo A_CONF_28; ?></a></li>
 <?php
 }
	?>
<!--					<li><a href="https://sourceforge.net/projects/phpmychat/files/phpMyChat_Plus/<?php echo(APP_LAST_VERSION); ?>" target=_blank Title="<?php echo(sprintf(L_CLICKS, L_LINKS_15, A_CONF_29)); ?>" onMouseOver="window.status='<?php echo(sprintf(L_CLICKS, L_LINKS_15, A_CONF_29)); ?>.'; return true"><?php echo A_CONF_29; ?></a></li>	-->
					<li><a href="https://sourceforge.net/projects/phpmychat/" target=_blank Title="<?php echo(sprintf(L_CLICKS, L_LINKS_15, A_CONF_30)); ?>" onMouseOver="window.status='<?php echo(sprintf(L_CLICKS, L_LINKS_15, A_CONF_30)); ?>.'; return true"><?php echo A_CONF_30; ?></a></li>
					<li><a href="https://sourceforge.net/p/phpmychat/code/HEAD/tree/trunk/" target=_blank Title="<?php echo(sprintf(L_CLICKS, L_LINKS_15, A_CONF_31)); ?>" onMouseOver="window.status='<?php echo(sprintf(L_CLICKS, L_LINKS_15, A_CONF_31)); ?>.'; return true"><?php echo A_CONF_31; ?></a></li>
					...
					<li><a href="https://sourceforge.net/p/phpmychat/code/HEAD/tree/trunk/docs/plus%20docs/Plus%20FAQ.txt" target=_blank Title="<?php echo(sprintf(L_CLICKS, L_LINKS_15, A_CONF_36)); ?>" onMouseOver="window.status='<?php echo(sprintf(L_CLICKS, L_LINKS_15, A_CONF_36)); ?>'; return true"><?php echo A_CONF_36; ?></a></li>
...
<?php
			echo("</td></tr><tr><td class=error align=center><h3>".sprintf(A_SHEET5_1,APP_LAST_VERSION.APP_LAST_MINOR)."<br />".sprintf(A_CONF_ERR_3, APP_LAST_VERSION.APP_LAST_MINOR, "<a href=\"https://sourceforge.net/projects/phpmychat/files/phpMyChat_Plus/".APP_LAST_VERSION."\" target=\"_blank\" Title=\"".sprintf(A_CONF_ERR_4, APP_LAST_VERSION.APP_LAST_MINOR)."\" onMouseOver=\"window.status='".sprintf(A_CONF_ERR_4, APP_LAST_VERSION.APP_LAST_MINOR).".'; return true\">".A_CONFHERE."</a></h3>"));
		}
?>
...
else
{
	...
	{
		echo "<p><table align=center border=0 cellpadding=3 class=menu style=\"background: white;\"><tr><td class=success align=center>".sprintf(A_CONFIMPORTANT, sprintf(A_CONF_ERR_2, "<span style=background-color:white>".C_LOG_DIR."</span>", "<span style=background-color:white>".$vLOG_DIR."</span><br />"))."</td></tr></table>";
	}
	echo "</p></div>";
}
...
if (C_LAST_SAVED_ON)
{
	$last_saved_on = mysql_to_ts(C_LAST_SAVED_ON);
	settype($last_saved_on, "integer");
	if (C_TMZ_OFFSET) { $tmz_offset = C_TMZ_OFFSET; settype($tmz_offset, "integer"); }
	...
	<td>
		...
		<?php
			...
			while(list($key, $langname) = each($AvailableLanguages))
			{
				...
				elseif ($langname == "finnish" && L_ORIG_LANG_FI != "L_ORIG_LANG_FI") $FLAG_NAME = L_ORIG_LANG_FI;
...
<tr>
	...
	<b><i><font color=red>* <?php echo sprintf(A_CONFHINT, A_CONFCONTENT_37); ?></i></b></font>
			<ul>
			...
			<i><font color=red><?php echo sprintf(A_CONFIMPORTANT, sprintf(A_CONFCONTENT_50, "<a href=#admin_email class=\"ChatLink\">".A_CONFHERE."</a>")); ?></i>
	</td>
</tr>
</table>
<table align="center" width="98%" class=table>
...
<tr>
	<td><b><?php echo A_CONFCONTENT_80; ?></b><br />
		<i><font color=red><?php echo sprintf(A_CONFIMPORTANT, A_CONFCONTENT_81); ?></font><br />
		<?php echo sprintf(A_CONFHINT, A_CONFCONTENT_82); ?></i>
	</td>
	<td>
...
<tr bgcolor="#B0C4DE">
	<td><b><?php echo A_CONFCONTENT_123; ?></b><br />
		<i><font color=red><?php echo sprintf(A_CONFIMPORTANT, A_CONFCONTENT_124); ?></font></i>
	</td>
	<td align="center">
...
<tr bgcolor="#B0C4DE">
	<td><b><?php echo A_CONFCONTENT_179; ?></b><br />
		...
		<?php echo sprintf(A_CONFHINT, A_CONFCONTENT_181); ?></i>
	</td>
	<td>
...
<tr>
	<td><b><?php echo A_CONFCONTENT_217 ?></b><br />
		<i><font color=red><?php echo sprintf(A_CONFIMPORTANT, A_CONF_ERR_11); ?></font><br />
		<?php echo sprintf(A_CONFHINT, A_CONFCONTENT_217a); ?><br />
		<font color=red><?php echo sprintf(A_CONFIMPORTANT, A_CONFCONTENT_124); ?></font></i>
	</td>
	<td>
...
<tr bgcolor="#B0C4DE">
	<td><b><?php echo A_CONFCONTENT_226; ?></b><br />
		...
		<i><font color=red><?php echo sprintf(A_CONFIMPORTANT, A_CONFCONTENT_228); ?></font></i><br />
...
<tr>
	...
	<td><?php echo A_CONFCONTENT_247; ?><br />
		...
		<input name="vWELCOME_SOUND" type="text" size="20" maxlength="255" value="<?php echo $WELCOME_SOUND; ?>"><br />
		<?php echo A_CONFCONTENT_248a; ?><br />
		<input name="vNOTIFY_SOUND" type="text" size="20" maxlength="255" value="<?php echo $NOTIFY_SOUND; ?>">
	</td>
</tr>
<tr bgcolor="#B0C4DE">
...
<tr>
	<td><b><?php echo A_CONFCONTENT_336; ?></b><br />
		<i><font color=red><?php echo sprintf(A_CONFIMPORTANT, sprintf(A_CONFCONTENT_336a, "<a href=\"player_popup.php?L=$L\" onClick=\"player_popup(); return false\" class=\"ChatLink\" target=\"_blank\">".A_CONFCONTENT_335a."</a>")); ?></font></i><br />
		<i><?php echo sprintf(A_CONFHINT, A_CONFCONTENT_336b); ?></i><br />
	</td>
	<td>
...
<tr>
	...
	<?php echo((!$cache_supported || $server_blocked) ? "<b>".A_CONFCONTENT_371b."</b><br />" : ""); ?>
		...
		<font color=blue><?php echo A_CONFCONTENT_377; ?>&nbsp;<b><?php echo(C_DB_TYPE == "mysql" ? mysql_get_server_info() : mysqli_get_server_info($GLOBALS["___mysqli_ston"])); ?></b></font><br />
...
<tr>
	...
	<i><?php echo sprintf(A_CONFHINT, A_CONFCONTENT_389); ?><br />
