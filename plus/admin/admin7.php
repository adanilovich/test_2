...
<?php
	// A registered user have to be deleted or banished?
...
if (isset($FORM_SEND) && $FORM_SEND == 7)
{
	...
	{
		// create query for 1
		$sql = "SELECT username,firstname,lastname,country,email,perms,ip,gender,colorname,birthday,show_bday,show_age,showemail,country_code,country_name FROM ".C_REG_TBL." WHERE (username LIKE '%".$searchTerm."%' OR firstname LIKE '%".$searchTerm."%' OR lastname LIKE '%".$searchTerm."%') AND email NOT LIKE '%@bot.com%' AND email NOT LIKE '%@quote.com%';";
		//echo $query;
	}
	elseif($searchCategory == 2 && $searchTerm != "")
	{
		// create query for 2
		$sql = "SELECT username,firstname,lastname,country,email,perms,ip,gender,colorname,birthday,show_bday,show_age,showemail,country_code,country_name FROM ".C_REG_TBL." WHERE ip LIKE '%".$searchTerm."%' AND email NOT LIKE '%@bot.com%' AND email NOT LIKE '%@quote.com%';";
	}
	elseif($searchCategory == 3 && $searchTerm != "")
	{
		// create query for 3
		$sql = "SELECT username,firstname,lastname,country,email,perms,ip,gender,colorname,birthday,show_bday,show_age,showemail,country_code,country_name FROM ".C_REG_TBL." WHERE perms LIKE '%".$searchTerm."%' AND email NOT LIKE '%@bot.com%' AND email NOT LIKE '%@quote.com%';";
	}
	elseif($searchCategory == 4 && $searchTerm != "")
	{
		// create query for 4
		$sql = "SELECT username,firstname,lastname,country,email,perms,ip,gender,colorname,birthday,show_bday,show_age,showemail,country_code,country_name FROM ".C_REG_TBL." WHERE email LIKE '%".$searchTerm."%' AND email NOT LIKE '%@bot.com%' AND email NOT LIKE '%@quote.com%';";
	}
	elseif($searchCategory == 5 && $searchTerm != "")
	{
		// create query for 5
		$sql = "SELECT username,firstname,lastname,country,email,perms,ip,gender,colorname,birthday,show_bdayshow_age,showemail,country_code,country_name FROM ".C_REG_TBL." WHERE gender='".$searchTerm."' AND email NOT LIKE '%@bot.com%' AND email NOT LIKE '%@quote.com%';";
	}
	elseif($searchCategory == 6 && $searchTerm != "")
	{
		// create query for 6
		$sql = "SELECT username,firstname,lastname,country,email,perms,ip,gender,colorname,birthday,show_bday,show_bday,show_age,showemail,country_code,country_name FROM ".C_REG_TBL." WHERE description LIKE '%".$searchTerm."%' AND email NOT LIKE '%@bot.com%' AND email NOT LIKE '%@quote.com%';";
	}
	elseif($searchCategory == 7 && $searchTerm != "")
	{
		// create query for 7
		$sql = "SELECT username,firstname,lastname,country,email,perms,ip,gender,colorname,birthday,show_bday,show_age,showemail,country_code,country_name FROM ".C_REG_TBL." WHERE (favlink LIKE '%".$searchTerm."%' OR favlink1 LIKE '%".$searchTerm."%' OR website LIKE '%".$searchTerm."%') AND email NOT LIKE '%@bot.com%' AND email NOT LIKE '%@quote.com%';";
	}
	elseif($searchCategory == 8 && $searchTerm != "")
	{
		// create query for 8
		$sql = "SELECT username,firstname,lastname,country,email,perms,ip,gender,colorname,birthday,show_bday,show_age,showemail,country_code,country_name FROM ".C_REG_TBL." WHERE birthday LIKE '%".$searchTerm."%' AND email NOT LIKE '%@bot.com%' AND email NOT LIKE '%@quote.com%';";
	}
	elseif($searchCategory == 10 && $searchTerm != "")
	{
		// create query for 10
		$sql = "SELECT username,firstname,lastname,country,email,perms,ip,gender,colorname,birthday,show_bday,show_age,showemail,country_code,country_name FROM ".C_REG_TBL." WHERE (country LIKE '%".$searchTerm."%' OR country_code LIKE '%".$searchTerm."%' OR country_name LIKE '%".$searchTerm."%') AND email NOT LIKE '%@bot.com%' AND email NOT LIKE '%@quote.com%';";
	}
	elseif($searchCategory == 9 && $searchTerm != "")
	{
		// create query for all categories 9
		$sql = "SELECT username,firstname,lastname,country,email,perms,ip,gender,colorname,birthday,show_bday,show_age,showemail,country_code,country_name FROM ".C_REG_TBL." WHERE (username LIKE '%".$searchTerm."%' OR firstname LIKE '%".$searchTerm."%' OR lastname LIKE '%".$searchTerm."%' OR country LIKE '%".$searchTerm."%' OR website LIKE '%".$searchTerm."%' OR ip LIKE '%".$searchTerm."%' OR perms LIKE '%".$searchTerm."%' OR email LIKE '%".$searchTerm."%' OR slang LIKE '%".$searchTerm."%' OR description LIKE '%".$searchTerm."%' OR favlink LIKE '%".$searchTerm."%' OR favlink1 LIKE '%".$searchTerm."%' OR birthday LIKE '%".$searchTerm."%' OR country_code LIKE '%".$searchTerm."%' OR country_name LIKE '%".$searchTerm."%') AND email NOT LIKE '%@bot.com%' AND email NOT LIKE '%@quote.com%';";
	}
	else
	{
	...
	while(list($s_username,$s_firstname,$s_lastname,$s_country,$s_email,$s_perms,$s_ip,$s_gender,$s_colorname,$s_birthday,$s_show_bday,$s_show_age,$s_showemail,$s_country_code,$s_country_name) = $DbLink->next_record())
	{
		...
		if ($s_username != $pmc_username) $s_edit = "<a onClick=\"browse_user($a_username);\" target=\"_self\" title=\"".A_SEARCH_25."\"><img src=images/edit.gif alt='".A_SEARCH_25."' title='".A_SEARCH_25."'></a>";
		...
		<td width=100 VALIGN=CENTER ALIGN=LEFT><B><FONT color=\"".$s_colorname."\">$s_username$bannished_user$s_edit</FONT></B></td>\n
		...
		unset($s_username,$s_firstname,$s_lastname,$s_country,$s_email,$s_perms,$s_ip,$s_gender,$s_birthday,$s_show_bday,$s_show_age,$s_ip,$s_colorname,$s_country_code,$s_country_name,$s_flag,$gender,$alt_gender,$s_edit);
		$bannished_user = "";
		$bannished_ip = "";
