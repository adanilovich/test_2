...
<?php
echo("<br /><a href=\"$From?avatar=$avatarmatch&User=$User&U=$User&L=$L&FORM_SEND=0&LIMIT=$LIMIT&pmc_password=$pmc_password&pmc_username=$User\" onMouseOver=\"window.status='".L_REG_10."'; return true;\" >".L_REG_10."</a>");
?>
</center>
