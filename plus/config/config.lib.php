...
define('C_DB_PREFIX', '');						// Prefix of your phpmychat tables (default is "c_ ")

// ------ THESE SETTINGS MUST NOT BE CHANGED ------

define("C_BAN_TBL", C_DB_PREFIX.'c_ban_users'); // Name of the table where banished users are stored
define("C_CFG_TBL", C_DB_PREFIX.'c_config'); 	// Name of the table where configuration settings are stored (if enabled)
define("C_LRK_TBL", C_DB_PREFIX.'c_lurkers'); 	// Name of the table where data about lurkers are stored (if enabled)
define("C_MSG_TBL", C_DB_PREFIX.'c_messages');	// Name of the table where messages are stored
define("C_REG_TBL", C_DB_PREFIX.'c_reg_users'); // Name of the table where registered users are stored
define("C_STS_TBL", C_DB_PREFIX.'c_stats'); 	// Name of the table where statistics data is stored (if enabled)
define("C_USR_TBL", C_DB_PREFIX.'c_users');		// Name of the table where user names are stored
