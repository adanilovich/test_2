...
class DB
{
    ...
    function halt($msg)
    {
		...
		echo("<B>MariaDB error</B>: $this->Errno ($this->Error)<br />\n");
		die("Session halted.");
    }
    ...
    function connect()
    {
		if(!$this->Link_ID)
		{
		    $this->Link_ID = ($GLOBALS["___mysqli_ston"] = mysqli_connect($this->Host,  $this->User,  $this->Password, $this->Database, ($this->Port != "" ? $this->Port : "3306")));
