...
define("APP_VERSION", '1.96');    						// Never modify/remove this line - it controls the update check up.
define("APP_MINOR", '');								// Never modify/remove this line - it controls the update check up.
define("RELEASE_DATE", '13 November 2017');				// Release date of this version
