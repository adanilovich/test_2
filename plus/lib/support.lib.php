...
switch (L_LANG)
{
	...
	case "el_GR":
		...
		break;
	case "fi_FI":
		$ppbutton = ($pptype == "big") ? "UVJSWB2FNWPKA" : "LRBWECTEKAQWA";
		$ppalt = "PayPal – turvallisempi ja helpompi tapa maksaa netissä!";
		break;
	case "hu_HU":
...
{
	case "big":
		$ppimage = "https://www.paypalobjects.com/$pplang/i/btn/btn_donateCC_LG.gif";
		$pmcimage = "./localization/".$L."/images/paypal_donate.gif";
		$defpmcimage = "./localization/english/images/paypal_donate.gif";
		break;
	case "small":
		$ppimage = "https://www.paypalobjects.com/".((L_LANG == "pt_BR" || L_LANG == "da_DK") ? L_LANG : (L_LANG == "zh_TW" ? "zh_HK" : $pplang))."/i/btn/btn_donate_SM.gif";
