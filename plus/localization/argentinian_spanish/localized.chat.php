<?php
// File : argentinian_spanish/localized.chat.php - plus version (04.11.2017 - rev.50) rev.45-49 to check
...
define("L_COOKIE", "%s utiliza cookies para mejorar la experiencia y proporcionar funcionalidades adicionales.<br />Ninguna de esta información puede ser o será utilizada para identificarle o contactarle."); //app name //rev.50
define("L_PRIVACY", "Política de Privacidad"); //rev.50
define("L_READ_PRIVACY", "para leer nuestra ".L_PRIVACY.""); //rev.50
define("L_AGREE", "Lo tengo!"); //rev.50
