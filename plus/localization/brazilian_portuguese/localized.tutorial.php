...
<P>
Clicando no ícone <IMG SRC="images/sound.gif" WIDTH=13 HEIGHT=13 BORDER=0 ALT="<?php echo(L_REG_53); ?>" TITLE="<?php echo(L_REG_53); ?>"> no topo desta janela pop-up, vai ligar/desligar os sons de aviso.
<br /><P ALIGN="right"><A HREF="#top">Voltar ao topo</A></P>
<P>
<hr />
<hr />
