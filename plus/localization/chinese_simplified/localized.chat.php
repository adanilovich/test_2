<?php
// File : chinese_simplified/localized.chat.php - plus version (04.11.2017 - rev.50) rev.46-49 to check
...
define("L_COOKIE", "%s使用cookie来增强浏览体验并提供附加功能。<br />这些数据都不能或将被用来识别或联系你。"); //app name //rev.50
define("L_PRIVACY", "隐私政策"); //rev.50
define("L_READ_PRIVACY", "阅读我们的".L_PRIVACY.""); //rev.50
define("L_AGREE", "知道了！"); //rev.50
