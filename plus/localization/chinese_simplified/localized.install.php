<?php
// File : chinese_simplified/localized.install.php - plus version (05.11.2017 - rev.10)
...
define("L_P2_FORM01", "资料库-主机 用于 phpMyChat"); //rev.8
...
define("L_P2_FORM17", "資料庫-港口 用于 phpMyChat（可选）"); //rev.8
define("L_P2_FORM18", "PDO数据库驱动程序（可选）"); //rev.9
define("L_P2_FORM19", "前缀为数据库表（可选）"); //rev.10
