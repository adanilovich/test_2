...
<P>
在 这个弹出式窗口顶部 按一下 " <IMG SRC="images/sound.gif" WIDTH=13 HEIGHT=13 BORDER=0 ALT="<?php echo( L_REG_53); ?>"> " 图示？会 启用/禁用 哔哔的声音在用户进室时。
<br /><P ALIGN="right"><A HREF="#top">回页首</A></P>
<P>
<hr />
<hr />
