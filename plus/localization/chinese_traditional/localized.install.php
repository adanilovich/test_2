<?php
// File : chinese_traditional/localized.install.php - plus version (05.11.2017 - rev.10)
...
define("L_P2_FORM01", "資料庫-主機 用於 phpMyChat"); //rev.8
...
define("L_P2_FORM17", "資料庫-港口 用於 phpMyChat（可選）"); //rev.8
define("L_P2_FORM18", "PDO數據庫驅動程序（可選）"); //rev.9
define("L_P2_FORM19", "前綴為數據庫表（可選）"); //rev.10
