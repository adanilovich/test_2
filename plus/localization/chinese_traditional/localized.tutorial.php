...
<TR>
	<TD ALIGN="center"><FONT SIZE="+2" COLOR="GREEN"><B>－ <?php echo(APP_NAME."－".APP_VERSION.APP_MINOR); ?> 繁體中文版本使用手冊 －</FONT><br /><I>&copy; 2012-<?php echo(date('Y')); ?> － 翻譯者 <a href="mailto:clouds.music@gmail.com?subject=phpMyChat%20Plus%20translation" onMouseOver="window.status='<?php echo (sprintf(L_CLICKS,L_LINKS_6,L_TRANSLATOR)); ?>。'; return true;" title="<?php echo (sprintf(L_CLICKS,L_LINKS_6,L_TRANSLATOR)); ?>" target=_blank>clouds_music</a> 來自 - 台灣，台北。</I></B></TD>
</TR>
</TABLE><br /><br />
<P><A NAME="top"></A></P>
...
<P>
在 這個彈出式窗口頂部 按一下 "<IMG SRC="images/sound.gif" WIDTH=13 HEIGHT=13 BORDER=0 ALT="<?php echo( L_REG_53); ?>">" 圖示？會 啟用/禁用 嗶嗶的聲音在用戶進室時。
<br /><P ALIGN="right"><A HREF="#top">回頁首</A></P>
<P>
<hr />
<hr />
