<?php
// File : danish/localized.chat.php - plus version (04.11.2017 - rev.50) rev.45-49 to check
...
define("L_COOKIE", "%s bruger cookies til at forbedre brugeroplevelse og funktionalitet.<br />Data vil ikke blive brugt til at identificere eller kontakte dig."); //app name //rev.50
define("L_PRIVACY", "Politik om Privatliv"); //rev.50
define("L_READ_PRIVACY", "for at læse vores ".L_PRIVACY.""); //rev.50
define("L_AGREE", "Forstået!"); //rev.50
