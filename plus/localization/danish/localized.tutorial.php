...
<TR>
	<TD ALIGN="center"><FONT SIZE="+2" COLOR="GREEN"><B>- Dansk Tutorial for <?php echo(APP_NAME." - ".APP_VERSION.APP_MINOR); ?> -</FONT><br /><I>&copy; 2008-<?php echo(date('Y')); ?> - Oversat af Bente Feldballe - Århus, Danmark.</I></B></TD>
</TR>
</TABLE><br /><br />
<P><A NAME="top"></A></P>
...
<P>
Hvis du klikker på ikonet<IMG SRC="images/sound.gif" WIDTH=13 HEIGHT=13 BORDER=0 ALT="<?php echo( L_REG_53); ?>"> øverst i dette pop-up vindue, kan du aktivere/deaktivere afspilning af beep, når en ny bruger slutter sig til chatten.
<br /><P ALIGN="right"><A HREF="#top">Tilbage til toppen</A></P>
<P>
<hr />
<hr />
