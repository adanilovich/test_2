<?php
// File : dutch/localized.config.php - plus version (05.11.2017 - rev.6)
...
define("A_CONF_ERR_2", "Vergeet niet de naam aan te passen van %s directorie naar %s (en zet de rechten op <b>777</b>)"); // %s = folder names (old|new)
...
define("A_CONFCONTENT_248a", "Op nieuw bericht:"); //rev.6
...
define("A_CONFCONTENT_335a", "Media Player Voorbeeld"); //rev.5
define("A_CONFCONTENT_336", "Het pad naar de streaming URL.");
define("A_CONFCONTENT_336a", "Voordat de live gaat, moet u uw eigen URLs te testen. Open de% s pagina voor een aantal werkende voorbeelden van streaming formaten en meer info."); //rev.5
define("A_CONFCONTENT_336b", "Browsers worden steeds met behulp van een aantal verschillende technologieën, dus sommige formaten werken mogelijk niet in alle browsers. Testen met verschillende browsers zal u helpen de beste beslissing te nemen en kennen de beperkingen.<br />We zullen proberen om de cross-browser compatibiliteit van dit HTML5 Media Player te verbeteren, dus blijf op zoek naar ".APP_NAME." updates."); //rev.5
...
define("A_CONFCONTENT_377", "MySQL/Database Server versie:");
