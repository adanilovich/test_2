...
define("A_SHEET4_13", "Put all recipients in the <b>’Bcc’</b> field"); //rev.17
...
define("A_SEARCH_26", "User has chosen to hide this info in public profiles, for his privacy. Do not disclose it!"); //rev.17
define("A_SEARCH_27", "Show current month"); //rev.17
define("A_SEARCH_28", "Show all birthdays"); //rev.17
