<?php
// File : french/localized.chat.php - plus version (04.11.2017 - rev.50)
...
define("L_REG_51", "Jamais"); //rev.48
define("L_REG_52", "Emplacement récent"); //rev.48
define("L_REG_53", "utilisez les notifications sonores"); //rev.48
...
define("L_ERR_USR_29", "Veuillez s’il vous plait renseigner votre date de naissance!<br />Une information incomplète n’est pas recevable."); //rev.49
...
define("L_LINKS_7", "pour visiter le site %s"); //rev.48
define("L_LINKS_8", "pour vous joindre au Groupe %s"); //rev.48
define("L_LINKS_9", "pour envoyer votre retour sur phpMyChat-Plus");
define("L_LINKS_10", "pour télécharger %s"); //rev.48
...
define("L_COOKIE", "%s utilise des cookies pour améliorer l'expérience de navigation et fournir des fonctionnalités supplémentaires.<br />Ces données ne seront pas utilisées pour vous identifier ou vous contacter."); //app name //rev.50
define("L_PRIVACY", "Politique de Confidentialité"); //rev.50
define("L_READ_PRIVACY", "pour lire notre ".L_PRIVACY.""); //rev.50
define("L_AGREE", "Je l’ai!"); //rev.50
...
define("L_LANG_CNS", "chinois (simplifié)");
define("L_LANG_CNT", "chinois (traditionnel)");
...
define("L_LANG_NB", "norvégien (Bokmål)");
define("L_LANG_NN", "norvégien (Nynorsk)");
define("L_LANG_PL", "polonais");
define("L_LANG_PT", "portugais");
define("L_LANG_RO", "roumain");
define("L_LANG_RU", "russe - cyrillique"); 
define("L_LANG_SRL", "serbe - latin");
define("L_LANG_SRC", "serbe - cyrillique");
define("L_LANG_SK", "slovaque");
define("L_LANG_SV", "suédois");
define("L_LANG_TH", "thailandais");
define("L_LANG_TR", "turque");
define("L_LANG_UK", "ukrainien - cyrillique");
define("L_LANG_UR", "ourdou"); //spoken in Pakistan
define("L_LANG_VI", "vietnamien");
define("L_LANG_YO", "yorubais"); //Nigeria&Congo language
