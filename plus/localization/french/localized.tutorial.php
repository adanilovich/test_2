...
<P>
En cliquant sur l’icône <IMG SRC="images/sound.gif" WIDTH=13 HEIGHT=13 BORDER=0 ALT="<?php echo L_REG_53 ?>"> en haut de cette fenêtre, vous activerez/désactiverez l’alerte sonore à la connexion d’un utilisateur sur le Chat.
<br /><P ALIGN="right"><A HREF="#top">Retour en haut de la page</A></P>
<P>
<hr />
<hr />
