<?php
// File : german/localized.chat.php - plus version (04.11.2017 - rev.50) rev.45-49 to check
...
define("L_COOKIE", "%s verwendet Cookies, um die Nutzererfahrung zu verbessern und den Benutzern bestimmte Dienste und Funktionen bereitzustellen.<br />Es werden keine der so gesammelten Daten genutzt, um Sie zu identifizieren oder zu kontaktieren."); //app name //rev.50
define("L_PRIVACY", "Datenschutzrichtlinie"); //rev.50
define("L_READ_PRIVACY", "um unsere ".L_PRIVACY." zu lesen"); //rev.50
define("L_AGREE", "Ich habs!"); //rev.50
