<?php
// File : hebrew/localized.chat.php - plus version (04.11.2017 - rev.50) rev.44-49 to check
...
define("L_COOKIE", "%s makes use of cookies to enhance browsing experience and provide additional functionality.<br />None of this data can or will be used to identify or contact you."); //app name //rev.50
define("L_PRIVACY", "מדיניות פרטיות"); //rev.50
define("L_READ_PRIVACY", "לקרוא את תנאי הפרטיות"); //rev.50
#define("L_READ_PRIVACY", "to read our ".L_PRIVACY.""); //rev.50
define("L_AGREE", "הבנתי!"); //rev.50
