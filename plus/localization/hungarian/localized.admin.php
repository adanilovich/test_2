<?php
// File : hungarian/localized.admin.php - plus version (04.11.2017 - rev.18)
...
define("A_SHEET4_13", "Tegye az összes címzett a <b>’Bcc’</b> mezőbe"); //rev.17
...
define("A_SEARCH_26", "Felhasználó úgy döntött, hogy rejteni ezt a info-ben nyilvános profilok, az ő magánélet. Ne nem hozzák nyilvánosságra it!"); //rev.17
define("A_SEARCH_27", "Aktuális hónap"); //rev.17
define("A_SEARCH_28", "Minden születésnap"); //rev.17
define("A_SEARCH_29", "%s nincs születésnapi ünneplés"); //rev.18
