<?php
// File : hungarian/localized.chat.php - plus version (05.11.2017 - rev.50)
...
define("L_REG_51", "Soha"); //rev.48
define("L_REG_52", "Legutóbbi hely"); //rev.48
define("L_REG_53", "használjon értesítési hangokat"); //rev.48
...
define("L_ERR_USR_29", "Kérjük, írja be születésnapját!<br />Hiányzó adatok nem fogadhatók el."); //rev.49
...
define("L_LINKS_7", " a %s Homepage megnyitásához"); //rev.48
define("L_LINKS_8", ", hogy csatlakozz a %s Group-hoz"); //rev.48
define("L_LINKS_9", " a visszajelzésed elküldéséhez");
define("L_LINKS_10", " a %s letöltéséhez"); //rev.48
...
define("L_COOKIE", " A %s cookie-kat használ a böngészési élmény fokozása és további funkciók biztosítása érdekében.<br />Ezen adatokat nem használjuk fel, illetve nem fogunk azonosítani vagy kapcsolatba lépni veled."); //app name //rev.50
define("L_PRIVACY", "Adatvédelmi Irányelvek"); //rev.50
define("L_READ_PRIVACY", " az ".L_PRIVACY." elolvasásához"); //rev.50
define("L_AGREE", "Rendben!"); //rev.50
