<?php
// File : indonesian/localized.chat.php - plus version (04.11.2017 - rev.50) rev.45-49 to check
...
define("L_COOKIE", "%s menggunakan cookies untuk meningkatkan pengalaman browsing dan menyediakan fungsionalitas tambahan.<br />Tak satu pun dari data ini dapat atau akan digunakan untuk mengidentifikasi atau menghubungi Anda."); //app name //rev.50
define("L_PRIVACY", "Kebijakan Pribadi"); //rev.50
define("L_READ_PRIVACY", "untuk membaca ".L_PRIVACY." kita"); //rev.50
define("L_AGREE", "Mengerti!"); //rev.50
