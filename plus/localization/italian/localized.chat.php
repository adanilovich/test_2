<?php
// File : italian/localized.chat.php - plus version (04.11.2017 - rev.50)
...
define("L_COOKIE", "%s fa uso di cookies per migliorare l'esperienza di navigazione e per fornire funzionalità aggiuntive.<br />Si tratta di dati del tutto anonimi, utili a scopo tecnico o statistico, e nessuno di questi dati verrà utilizzato per identificarti o per contattarti."); //app name //rev.50
define("L_PRIVACY", "Privacy"); //rev.50
define("L_READ_PRIVACY", "leggere le norme sulla ".L_PRIVACY.""); //rev.50
define("L_AGREE", "Capito!"); //rev.50
