<?php
// File : japanese/localized.chat.php - plus version (04.11.2017 - rev.50) rev.45-49 to check
...
define("L_COOKIE", "%sは、ブラウジング体験を強化し、追加機能を提供するためにクッキーを使用しています。<br />このデータのどれもあなたを特定したり連絡したりすることはできません。"); //app name //rev.50
define("L_PRIVACY", "個人情報保護方針"); //rev.50
define("L_READ_PRIVACY", "プライベートポリシーを読む"); //rev.50
#define("L_READ_PRIVACY", "to read our ".L_PRIVACY.""); //rev.50
define("L_AGREE", "それを得た！"); //rev.50
