<?php
// File : romanian/localized.chat.php - plus version (04.11.2017 - rev.50)
...
define("L_COOKIE", "%s folosește cookie-uri pentru a vă îmbunătăți experiența de navigare și a asigura funcționalițăți adiționale.<br />Nici o parte din aceste date nu poate si nu va fi folosită pentru a te identifica sau contacta."); //app name //rev.50
define("L_PRIVACY", "Declaraţia de Confidenţialitate"); //rev.50
define("L_READ_PRIVACY", "pentru a citi ".L_PRIVACY.""); //rev.50
define("L_AGREE", "Am înţeles!"); //rev.50
