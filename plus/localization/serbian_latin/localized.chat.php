<?php
// File : serbian_latin/localized.chat.php - plus version (04.11.2017 - rev.50)
...
define("L_COOKIE", "%s koristi kolačiće za poboljšanje iskustvo pregledanja i obezbeđuju dodatnu funkcionalnost.<br />Nijedan od ovih podataka može ili će se koristiti za identifikaciju ili kontakt sa vama."); //app name //rev.50
define("L_PRIVACY", "Politiku Privatnosti"); //rev.50
define("L_READ_PRIVACY", "pročitate našu ".L_PRIVACY.""); //rev.50
define("L_AGREE", "Razumem!"); //rev.50
