...
<TR>
	<TD ALIGN="center"><FONT SIZE="+2" COLOR="GREEN"><B>- Srpski Tutorijal za <?php echo(APP_NAME." - ".APP_VERSION.APP_MINOR); ?> -</FONT><br /><I>&copy; 2008-<?php echo(date('Y')); ?> - Preveo <a href="mailto: vedran.vucic@gnulinuxcentar.org?subject=phpMyChat%20Plus%20translation" onMouseOver="window.status='<?php echo (sprintf(L_CLICKS,L_LINKS_6,L_TRANSLATOR)); ?>.'; return true;" title="<?php echo (sprintf(L_CLICKS,L_LINKS_6,L_TRANSLATOR)); ?>" target=_blank>Vedran Vučić</a> - Beograd, Serbia.</I></B></TD>
</TR>
</TABLE><br /><br />
<P><A NAME="top"></A></P>
...
<P>
Klikom na <IMG SRC="images/sound.gif" WIDTH=13 HEIGHT=13 BORDER=0 ALT="<?php echo( L_REG_53); ?>"> sličicu na vrhu ovog iskačućeg prozora će omogućiti/onemogućiti zvučni signal prilikom ulaska korisnika.
<br /><P ALIGN="right"><A HREF="#top">Povratak na vrh</A></P>
<P>
<hr />
<hr />
