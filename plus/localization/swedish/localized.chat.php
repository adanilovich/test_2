<?php
// File : swedish/localized.chat.php - plus version (04.11.2017 - rev.50) - 45-49 to check
...
define("L_COOKIE", "%s använder cookies för att förbättra webbupplevelse och ge ytterligare funktionalitet.<br />Inget av dessa data kan eller kommer att användas för att identifiera eller kontakta dig."); //app name //rev.50
define("L_PRIVACY", "Policy om Personuppgifter"); //rev.50
define("L_READ_PRIVACY", "för att öppna ".L_PRIVACY.""); //rev.50
define("L_AGREE", "Fick det!"); //rev.50
