<?php
// File : turkish/localized.chat.php - plus version (04.11.2017 - rev.50) rev.45-49 to check
...
define("L_COOKIE", "%s gezen deneyimini geliştirmek ve ek işlevsellik sağlamak için çerez kullanır.<br />Bu verilerin hiçbiri veya tanımlamak veya sizinle iletişim için kullanılacaktır olabilir."); //app name //rev.50
define("L_PRIVACY", "Gizlilik Politikamızı"); //rev.50
define("L_READ_PRIVACY", "".L_PRIVACY." okuyun"); //rev.50
define("L_AGREE", "Anladım!"); //rev.50
