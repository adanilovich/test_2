...
<TR>
	...
	<br /><I>&copy; 2007-<?php echo(date('Y')); ?> - Türkçeye çeviren <a href="mailto:vovun@ttnet.net.tr?subject=Türkçe%20phpMyChat%20Plus%20çevirisi" onMouseOver="window.status='<?php echo (sprintf(L_CLICKS,L_LINKS_6,L_TRANSLATOR)); ?>.'; return true;" title="<?php echo (sprintf(L_CLICKS,L_LINKS_6,L_TRANSLATOR)); ?>" target=_blank>Volkan Övün</a> - Ankara, Türkiye.</I></B></TD></TD>
</TR>
</TABLE><br /><br />
<P><A NAME="top"></A></P>
...
<P>
Bu yeni açılan pencerenin yukarısındaki <IMG SRC="images/sound.gif" WIDTH=13 HEIGHT=13 BORDER=0 ALT="<?php echo L_REG_53 ?>"> ikonuna tıklamak, içeri kullanıcı girdiği zaman çalan sinyal sesini açar veya kapatır.
<br /><P ALIGN="right"><A HREF="#top">Sayfa başına dön</A></P>
<P>
<hr />
<hr />
