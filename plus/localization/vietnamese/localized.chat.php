<?php
// File : vietnamese/localized.chat.php - plus version (04.11.2017 - rev.50) rev.45-49 to check
...
define("L_COOKIE", "%s sử dụng cookie để nâng cao trải nghiệm duyệt web và cung cấp thêm chức năng.<br />Không ai trong số dữ liệu này có thể hoặc sẽ được sử dụng để xác định hoặc liên lạc với bạn."); //app name //rev.50
define("L_PRIVACY", "Chính sách riêng tư"); //rev.50
define("L_READ_PRIVACY", "để đọc của chúng tôi ".L_PRIVACY.""); //rev.50
define("L_AGREE", "Hiểu rồi!"); //rev.50
