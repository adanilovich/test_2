...
</FONT><br /><I>&copy; 2007-<?php echo(date('Y')); ?> - Dịch bởi Marshall - Mỹ Tho, VIỆT NAM.</I></B></TD>
</TR>
</TABLE><br /><br />
<P><A NAME="top"></A></P>
...
<P>
Click vào<IMG SRC="images/sound.gif" WIDTH=13 HEIGHT=13 BORDER=0 ALT="<?php echo L_REG_53 ?>"> việc click vào biểu tượng trên cùng làm tắt đi âm thanh beep cho người sử dụng.
<br /><P ALIGN="right"><A HREF="#top">Quay lại từ đầu</A></P>
<P>
<hr />
<hr />
