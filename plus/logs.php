...
#					else $dyhtmu=str_replace(".php","",$dyu);
					...
					echo ("<li><a href=$du/$dyu?L=$L onMouseOver=\"window.status='".sprintf(A_CHAT_LOGS_16,$dyhtmu." ".$MONTHU)."'; return true;\" title='".sprintf(A_CHAT_LOGS_16,$dyhtmu." ".$MONTHU)."' target=_top>$dyhtmu</a> (".size_readable(filesize($du."/".$dyu)).")<br />\n"); #print name of each file found
