...
$DbLink->query("SELECT m_time, room, username, latin1, address, message FROM ".C_MSG_TBL." WHERE ".$CondForQuery.$Type." ORDER BY m_time DESC LIMIT $N");
...
<TR>
	<TD ALIGN=CENTER colspan="<?php echo(($status == "a" || $status == "t" || $status == "m") ? 6 : 5); ?>" nowrap="nowrap">
		<?php
