...
?>
		<TR valign="top">
			<TD align="left">
				<br /><input type="text" name="srcu" id="srcu" value="<?php echo($srcu); ?>" size="40">&nbsp;<input type="submit" name="Submit" value="Load your media source" />
			</TD>
		</TR>
		<TR valign="top">
			<TD align="center">
