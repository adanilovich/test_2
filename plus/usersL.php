...
if (C_DB_TYPE == 'mysqli' || C_DB_TYPE == 'mysql' || C_DB_TYPE == 'mariadb')
{
...
<div id="menu">
	<dl>
		...
		<dd id="smenu1" onmouseover="javascript:show('smenu1');" onmouseout="javascript:show('');">
			<ul>
				<li><a href="<?php echo($ChatPath); ?>privacy.html" onClick="window.parent.privacy_popup(); return false" TARGET="_blank" title="<?php echo(sprintf(L_CLICK,L_READ_PRIVACY)); ?>" onMouseOver="window.status='<?php echo(sprintf(L_CLICK,L_READ_PRIVACY)); ?>'; return true"><?php echo(L_PRIVACY); ?></a></li>
