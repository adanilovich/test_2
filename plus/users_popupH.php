...
#		if (eregi("MSIE", $_SERVER['HTTP_USER_AGENT']))
		...
		?>
		<A HREF="users_popupH.php?<?php echo($ChangeBeeps_Reload); ?>" onMouseOver="window.status='<?php echo(L_REG_53); ?>.'; return true;" title="<?php echo(L_REG_53); ?>"><IMG SRC="images/<?php if ($B == 0) echo("no"); ?>sound.gif" WIDTH=13 HEIGHT=13 ALIGN="MIDDLE" BORDER=0 ALT="<?php echo(L_REG_53); ?>"></A>
		<?php
		// ** Beeps if necessary **
		if($B && $BeepRoom)
		{
